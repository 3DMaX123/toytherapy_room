    ...
    render() {
        return (
            <div className='app__compCatalog'>
                ...
                <img className='compCatalog__props_phone' src={images.catalog__props_phone} alt='Різні пропси телефон' />
                <div className='compCatalog__textAndButton'>
                    <div className='compCatalog__textAndButton_headerDescription'>
                        ...
                        <p className='compCatalog__headerDescription-description'>Вони різні, але кожна має свою особливу силу... Серед них є та єдина,<br />що чекала саме тебе, адже її сила здатна допомогти тобі</p>
                    </div>
