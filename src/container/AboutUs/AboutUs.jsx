...
const AboutUs = () => {
    ...
    return (
        <div className='app__aboutUs'>
            ...
            <div className='aboutUs__textBlock aboutUs__aboutUsTextBlock'>
                ...
                <img className="aboutUs__decorations_headerPhone aboutUs__decorationsPhone" src={images.aboutUs__header_phoneDecorations} alt='"Хмаринки та сердечки' />
            </div>
            ...
            <div className='aboutUs__textBlock'>
                ...
                <img className="aboutUs__decorations_goalPhone aboutUs__decorationsPhone" src={images.aboutUs__decorations_goalPhone} alt='"Хмаринки та сердечки' />
            </div>
            <div className='aboutUs__textBlock aboutUs__forWhatTextBlock'>
            ...
            <div className='aboutUs__textBlock aboutUs__textBlockResults'>
                ...
                <img className="aboutUs__decorations_dryingPhone aboutUs__decorationsPhone" src={images.aboutUs__decorations_dryingPhone} alt='Хмаринки та сердечки' />
            </div>
            <p className='aboutUs__-subHeader aboutUs__resultsSubHeader'>Що вже зроблено станом на сьогодні</p>
            <div className='aboutUs__textBlock'>
                ...
                <img className="aboutUs__decorations_resultsPhone aboutUs__decorationsPhone" src={images.aboutUs__decorations_resultsPhone} alt='Хмаринки та сердечки' />
            ...
            <div className='aboutUs__contacts'>
                ...
                <img className="aboutUs__decorations_contactsPhone aboutUs__decorationsPhone" src={images.aboutUs__decorations_contactsPhone} alt='Хмаринки та сердечки' />
            </div>
            ...
            <div className='aboutUs__gradients'>
                ...
                <img className="aboutUs__gradients-resultsPhone" src={images.aboutUs__gradients_goal} alt='Градієнт' />
                <img className="aboutUs__gradients-alreadyDone" src={images.aboutUs__gradients_alreadyDone} alt='Градієнт' />
                <img className="aboutUs__gradients-alreadyDonePhone" src={images.aboutUs__gradients_header} alt='Градієнт' />
